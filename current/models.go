...
func (s serviceImpl) UpgradeMedia(id int) (*Media, error) {
	return s.db.UpgradeMedia(id)
}

func (s serviceImpl) DowngradeMedia(id int) (*Media, error) {
	return s.db.DowngradeMedia(id)
}
